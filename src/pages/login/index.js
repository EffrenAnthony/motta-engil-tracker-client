...
export const Login = () => {
  ...
  return (
    <div className="w-full max-h-full md:max-h-screen">
      <div className="flex max-h-full md:max-h-screen max-w-screen-3xl m-auto">
        <div className="w-2/5 min-h-screen grid grid-rows-3 grid-flow-col gap-0">
        ...
        <div className="w-3/5 min-h-screen flex justify-center items-center">
          <div className="w-2/5 h-4/6 flex  items-center flex-col rounded  shadow-lg shadow-blue-500/50 py-3 px-3 ">
